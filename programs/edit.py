...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("LopaWriter for LopaOS")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","LopaWRITER official text editor for LopaOS (C) Lopastudio 2021")
